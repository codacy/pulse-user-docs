...
-   [Lead time for changes](metrics/accelerate.md#lead-time-for-changes), including the drill-down metrics:
    -   [Time to open](metrics/lead-time-reviews.md#time-to-open) and [Time to merge](metrics/lead-time-reviews.md#time-to-merge)
    -   [Time to first/last approve](metrics/lead-time-reviews.md#time-to-firstlast-approve) and [Time to first/last review](metrics/lead-time-reviews.md#time-to-firstlast-review)
