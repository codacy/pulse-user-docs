...
1.  Choose the strategy that will be used to automatically detect deployments that best fits your workflows, or turn off the automatic deployment detection.
    ...
    -   **Use merged pull requests** (default)
        ...
        -   Pulse associates all GitHub teams of the author of a merged pull request with the corresponding deployment, excluding teams with less than three members.
    ...
    -   **Use semantic versioning tags**
        ...
        -   Pulse associates all GitHub teams of the person who creates a Git tag with the corresponding deployment, excluding teams with less than three members.
